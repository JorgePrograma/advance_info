...
import { PermissionService } from '@developeradaza/permissions-lib';
...
export class UserTableComponent implements OnInit {
  ...
  public CREATE_USER_PERMISSION = PermissionConstant.CREATE_USER;
  ...
  constructor() {
    this.sharedStatePermission.state$.pipe(takeUntilDestroyed())
      .subscribe(permissions => {
        console.log('Permisos desde SharedStateService:', permissions);
  ...
  ngOnInit(): void {
    ...
    console.log('se va a mostrar los permisos del usuario'); // <-- Esto mostrará los permisos en consola
