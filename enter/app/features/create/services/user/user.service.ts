...
export class UserService {
   ...
   */
  registerBasicInfo(
    basicInfo: Omit<BasicInfoModel, 'id'>
  ...
  registerAccountDirectory(
    ...
    return this.http
      .post<ResponseModel<any>>(
        EndPoints.CREATE_ACCOUNT_WITH_DIRECTORY,
        accountInfo,
        {
          headers: this.getHeaders(),
        }
  ...
  getUserByDocument(documentNumber: string): Observable<boolean> {
    ...
    return this.http
      ...
      .pipe(
        map((response) => {
          // Return true if user exists (items.length > 0)
  ...
  getUserByUserName(userName: string): Observable<boolean> {
    const url = `${EndPoints.GET_USER_BY_USER}?userName=${userName}`;
    return this.http
      .get<ResponseModel<ResponseUser>>(url, { headers: this.getHeaders() })
      .pipe(
        map((response) => {
  ...
  updateBasicInfo(
    ...
    return this.http.put<ResponseModel<string>>(EndPoints.UPDATE_PEOPLE, {
      ...basicInfo,
      idPerson,
    });
  }
  ...
  updateContactInfo(
    ...
    return this.http.put<ResponseModel<string>>(EndPoints.UPDATE_CONTACT, {
      ...contactInfo,
      idContact,
    });
  }
  ...
  updateEmployeeInfo(
    ...
    return this.http.put<ResponseModel<string>>(EndPoints.UPDATE_EMPLOYEE, {
      ...employeeInfo,
      idEmployee,
    });
  }
  ...
  updateAccountInfo(
    ...
    return this.http.put<ResponseModel<string>>(EndPoints.UPDATE_USERS, {
      ...accountInfo,
      idUser,
    });
  }
