export class EndPoints {
  ...
  static readonly GET_ALL_LOCATIONS =
    this.base_url + '/Redis/getValue/location';
  ...
  static readonly GET_ALL_POSITION =
    this.base_url + '/position/get-all-positions';
  ...
  static readonly CREATE_EMPLOYEE = this.base_url + '/employee/create-employee';
  ...
  static readonly GENERATE_AUTH_FOR_USER =
    this.base_url + '/security/generate-by-parameters';
  static UPLOAD_DIGITAL_SIGNATURE: any;
  static UPLOAD_RUBRICA_SIGNATURE: any;
  static DELETE_SIGNATURE: any;
  static GET_USER_SIGNATURES: any;
}

/***
 *
 * https://femrwzf6x6uakaqkb32tl27hgm.apigateway.sa-bogota-1.oci.customer-oci.com/api/v1/users/get-by-filter
 * https://femrwzf6x6uakaqkb32tl27hgm.apigateway.sa-bogota-1.oci.customer-oci.com/api/v1/user/get-by-filter
 */
